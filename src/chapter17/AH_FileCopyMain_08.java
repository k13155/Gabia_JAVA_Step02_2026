...
public class AH_FileCopyMain_08 {
	...
	public static void main(String[] args) {
		...
		long endTime = System.nanoTime(); // 복사 시작
	...
	public static void createTestFile(String filePath, int sizeInBytes)
	{
		...
		{
			System.out.println("파일 생성 중 오류 발새이 " + e.getMessage());
		}
	...
	public static void copyWithoutBuffer(String source, String dest)
	{
				...
				FileOutputStream fos = new FileOutputStream(dest))
		{
			...
			// FileInputInputStream 사용시 용량지정 가능
	...
	public static void copyWithBuffer(String source, String dest)
	{
		...
		{
			System.out.println("파일 복사 중 오류 발새이 " + e.getMessage());
		}
	}
